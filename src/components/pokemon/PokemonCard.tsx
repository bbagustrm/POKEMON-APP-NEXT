        ...
        <>
            ...
            >
              ...
              #{paddedId}
                    ...
                    {/* Sprite — pakai <img> agar GIF animated berjalan */}
                    <div className="flex justify-center mt-2 mb-3 h-28 items-center">
                        ...
                        <img
                            ...
                            width={112}
                            height={112}
                            className="object-contain drop-shadow-md group-hover:scale-110
                    ...
                    <div className="flex gap-2">
                        {isCaught ? (
                            <>
                             ...
                             text-xs font-semibold font-display opacity-60 cursor-not-allowed"
                                ...
                                <button
                                    ...
                                    className="cursor-pointer flex items-center justify-center gap-1 rounded-xl py-2 px-3
                            ...
                            <button
                                ...
                                className="cursor-pointer flex-1 flex items-center justify-center gap-1.5 rounded-xl py-2
