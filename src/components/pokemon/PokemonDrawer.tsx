        ...
        <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                    ...
                    <span
                        className="text-xs font-bold uppercase tracking-wide font-display"
                        style={{color: cfg.color}}
                    >
                        {cfg.label}
                    </span>
...
function EvolutionCard({id, name, trigger, minLevel, item}: {
    ...
    return (
        <div className="flex flex-col items-center gap-1">
            <div className="w-48 h-48 flex items-center justify-center rounded-2xl bg-gray-50 border border-gray-100">
                <Image
                    ...
                    <section>
                        ...
                        <div className="flex flex-col gap-2">
                            <div className="rounded-2xl p-3 bg-gray-50 border border-gray-100">
                                <p className="text-[10px] text-gray-400 font-display uppercase tracking-wide mb-4">Gender</p>
                                {genderRate === -1 ? (
                                    ...
                                    <div className="flex flex-col gap-4">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <span className="text-blue-400 text-xs font-bold font-display w-18">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <span className="text-pink-400 text-xs font-bold font-display w-18">
                                                ♀ {femaleChance?.toFixed(0)}%
                                            </span>
                                            <div className="flex-1 h-3 rounded-full bg-gray-200 overflow-hidden">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div className="rounded-2xl p-3 bg-gray-50 border border-gray-100">
                                    <p className="text-[10px] text-gray-400 font-display uppercase tracking-wide mb-1">Egg
                                        Groups</p>
                                ...
                                <div className="rounded-2xl p-3 bg-gray-50 border border-gray-100">
                                    <p className="text-[10px] text-gray-400 font-display uppercase tracking-wide mb-1">Growth
                                        Rate</p>
                                    <p className="text-sm font-bold font-display text-gray-800 capitalize">
                        ...
                        <div className="flex flex-col gap-2">
                            {abilities.map((a) => (
                                <div key={a.ability.name}
                                    ...
                                    {a.is_hidden && (
                                        <span
                                            className="text-[10px] font-bold font-display px-2 py-0.5 rounded-full bg-purple-100 text-purple-600">
                                            Hidden
                                        </span>
                                    )}
                                </div>
                                    ...
                                    {i < evolution.length - 1 && (
                                        <div className="flex flex-col items-center py-2 gap-3">
                                            ...
                                            {evolution[i + 1]?.minLevel && (
                                                <span
                                                    className="text-[10px] font-bold font-display text-gray-400 bg-gray-100 rounded-full px-2 py-0.5">
                                                    Lv. {evolution[i + 1].minLevel}
                                                </span>
                                            )}
                                            {evolution[i + 1]?.item && (
                                                <span
                                                    className="text-[10px] font-bold font-display text-gray-400 bg-gray-100 rounded-full px-2 py-0.5 capitalize">
        ...
        <>
            ...
            <div
                ...
                className={[
                    ...
                    // Desktop: right panel
                    "md:inset-y-0 md:left-auto md:right-0 md:w-[80vw] md:max-w-5xl",
